...
export class ImportService {
    ...
    private setupInstructionsSheet(sheet: ExcelJS.Worksheet): void {
        ...
        const instructions = [
            ...
            { text: '• nombre: Nombre del modelo (ej: "\'71 Datsun 510")', style: 'normal' },
            { text: '• fabricante: Fabricante del modelo a escala (ej: "Hot Wheels")', style: 'normal' },
            { text: '• marca: Marca del vehículo real (ej: "Nissan")', style: 'normal' },
            { text: '• escala: Escala del modelo (ej: "1/64")', style: 'normal' },
            { text: '• color: Color principal del modelo', style: 'normal' },
            { text: '• condición: Estado del empaque', style: 'normal' },
            { text: '', style: 'normal' },
            { text: 'Campos opcionales:', style: 'subtitle' },
            { text: '• serie: Serie o colección (ej: "Japan Historics")', style: 'normal' },
            { text: '• descripción: Notas adicionales', style: 'normal' },
            { text: '', style: 'normal' },
